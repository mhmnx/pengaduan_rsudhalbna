...
--
-- Host: MHMNX.mysql.pythonanywhere-services.com    Database: MHMNX$db
-- ------------------------------------------------------
...
CREATE TABLE `aduan` (
  ...
  `jenis` enum('Hijau','Kuning','Merah') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tujuan` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `isi` text COLLATE utf8mb4_general_ci,
  `status` enum('Diterima','Diproses','Selesai') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2025-06-18  4:01:11
